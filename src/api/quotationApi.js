...
export const createQuotation = (presalesSrNumber, quotation) =>
  api.post('/quotation/createquotation', quotation, {
    params: { presalesSrNumber }
  });

export const updateQuotationStatus = (quotationNumber, isAccepted) =>
  api.put('/quotation/updatequotationstatus', null, {
    params: { quotationNumber, isAccepted }
  });

export const updateQuotation = (quotation, quotationNumber) =>
  api.put('/quotation/updatequotation', quotation, {
    params: { quotationNumber }
  });